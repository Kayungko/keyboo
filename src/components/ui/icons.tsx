// Keyboo 自定义线性图标(鼠标动作类,lucide 风格)
// 临时借用自 Keyviz 的美术素材,后期迭代替换
...
export const MouseScrollUpIcon = createCustomIcon("MouseScrollUpIcon", (
  <>
    <path d="M19 9C19 5.13401 15.866 2 12 2C8.13401 2 5 5.13401 5 9V15C5 18.866 8.13401 22 12 22C15.866 22 19 18.866 19 15V9Z" />
    <path d="M12 7V12" />
...
export const MouseScrollDownIcon = createCustomIcon("MouseScrollDownIcon", (
  <>
    <path d="M19 9C19 5.13401 15.866 2 12 2C8.13401 2 5 5.13401 5 9V15C5 18.866 8.13401 22 12 22C15.866 22 19 18.866 19 15V9Z" />
    <path d="M12 7V12" />
